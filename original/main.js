...
function update(async = true) {
  function update_hsl_manipulators(prefix, to_hsl) {
    ...
    document
      .getElementById(prefix + '_hs_manipulator')
      .transform.baseVal.getItem(0)
      .setTranslate(picker_size * hsl_a, picker_size * (1 - hsl_b));
    document
      .getElementById(prefix + '_l_manipulator')
      .transform.baseVal.getItem(0)
      .setTranslate(0, picker_size * (1 - hsl[2]));

    document
      .getElementById(prefix + '_hl_manipulator')
      .transform.baseVal.getItem(0)
      .setTranslate(picker_size * hsl[0], picker_size * (1 - hsl[2]));
    document
      .getElementById(prefix + '_s_manipulator')
      .transform.baseVal.getItem(0)
      .setTranslate(0, picker_size * (1 - hsl[1]));

    document
      .getElementById(prefix + '_sl_manipulator')
      .transform.baseVal.getItem(0)
      .setTranslate(picker_size * hsl[1], picker_size * (1 - hsl[2]));
    document
      .getElementById(prefix + '_h_manipulator')
      .transform.baseVal.getItem(0)
      .setTranslate(0, picker_size * hsl[0]);

    document.getElementById(prefix + '_h_input').value = Math.round(
      360 * hsl[0]
    );
    document.getElementById(prefix + '_s_input').value = Math.round(
      100 * hsl[1]
    );
    document.getElementById(prefix + '_l_input').value = Math.round(
      100 * hsl[2]
    );
  }
  ...
  document
    .getElementById('hsv_sv_manipulator')
    .transform.baseVal.getItem(0)
    .setTranslate(picker_size * hsv[1], picker_size * (1 - hsv[2]));
  document
    .getElementById('hsv_h_manipulator')
    .transform.baseVal.getItem(0)
    .setTranslate(0, picker_size * hsv[0]);
  ...
  document
    .getElementById('okhsv_sv_manipulator')
    .transform.baseVal.getItem(0)
    .setTranslate(picker_size * okhsv[1], picker_size * (1 - okhsv[2]));
  document
    .getElementById('okhsv_h_manipulator')
    .transform.baseVal.getItem(0)
    .setTranslate(0, picker_size * okhsv[0]);
...

  {
    ...
    document
      .getElementById('oklch_lc_manipulator')
      .transform.baseVal.getItem(0)
      .setTranslate((picker_size * C) / oklab_C_scale, picker_size * (1 - L));
    document
      .getElementById('oklch_h_manipulator')
      .transform.baseVal.getItem(0)
      .setTranslate(0, picker_size * h);
...
function initialize() {
  ...
  function setup_hsl_handlers(prefix, to_hsl, from_hsl) {
    setup_handler(
      document.getElementById(prefix + '_hs_canvas'),
      function (x, y) {
        let hsl = to_hsl(r, g, b);
    ...
    setup_handler(
      document.getElementById(prefix + '_l_canvas'),
      function (x, y) {
    ...
    setup_handler(
      document.getElementById(prefix + '_hl_canvas'),
      function (x, y) {
        let hsl = to_hsl(r, g, b);
    ...
    setup_handler(
      document.getElementById(prefix + '_s_canvas'),
      function (x, y) {
    ...
    setup_handler(
      document.getElementById(prefix + '_sl_canvas'),
      function (x, y) {
        let hsl = to_hsl(r, g, b);
    ...
    setup_handler(
      document.getElementById(prefix + '_h_canvas'),
      function (x, y) {
    ...
    setup_input_handler(
      document.getElementById(prefix + '_h_input'),
      function (h) {
        h = clamp(h / 360);
        let hsl = to_hsl(r, g, b);
        rgb = from_hsl(h, hsl[1], hsl[2]);
    ...
    setup_input_handler(
      document.getElementById(prefix + '_s_input'),
      function (s) {
        s = clamp(s / 100);
        let hsl = to_hsl(r, g, b);
        rgb = from_hsl(hsl[0], s, hsl[2]);
    ...
    setup_input_handler(
      document.getElementById(prefix + '_l_input'),
      function (l) {
        l = clamp(l / 100);
        let hsl = to_hsl(r, g, b);
        rgb = from_hsl(hsl[0], hsl[1], l);
  ...
  setup_handler(document.getElementById('oklch_lc_canvas'), function (x, y) {
    ...
    let new_L =
      y < picker_size ? toe_inv(1 - y / picker_size) : 1 - y / picker_size;
    ...
    if (new_L < eps)
      // avoid strange behavior around L = 0
      new_C = eps * new_L;
  ...
  document.getElementById('hex_input').addEventListener(
    'change',
    (event) => {
